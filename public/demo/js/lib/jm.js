	...
	(function($, window, undefined) {
		...
		$.mobile = $.extend($.mobile, {
			...
			closestPageData: function($target) {
				return $target.closest(':jqmData(role="page"), :jqmData(role="dialog")')
					.data("mobile-page");
			},
			...
			if (!($.mobile.allowCrossDomainPages || path.isSameDomain(documentUrl, absUrl))) {
				...
				$.ajax({
					...
					success: function(html, textStatus, xhr) {
						...
						page.attr("data-" + $.mobile.ns + "url", path.convertUrlToDataUrl(fileUrl))
			...
			_create: function() {
				...
				collapsible.bind("expand collapse", function(event) {
					if (!event.isDefaultPrevented()) {
						...
						collapsibleHeading.toggleClass("ui-collapsible-heading-collapsed", isCollapse)
		...
		$.widget("mobile.collapsibleset", $.mobile.widget, {
			...
			_create: function() {
				...
				if (!$el.jqmData("collapsiblebound")) {
					$el.jqmData("collapsiblebound", true)
						.bind("expand", function(event) {
							var closestCollapsible = $(event.target)
								.closest(".ui-collapsible");
							if (closestCollapsible.parent().is(":jqmData(role='collapsible-set')")) {
								closestCollapsible.siblings(".ui-collapsible")
									.trigger("collapse");
							}
						});
				}
		...
		$.widget("mobile.listview", $.mobile.widget, {
			...
			_createSubPages: function() {
				...
				if (hasSubPages && parentPage.is(":jqmData(external-page='true')") && parentPage.data("mobile-page").options.domCache === false) {
					...
					parentPage.unbind("pagehide.remove")
	...
	(function($, undefined) {
		...
		$.widget("mobile.controlgroup", $.mobile.widget, {
			...
			_setType: function(value) {
				this.element.removeClass("ui-controlgroup-horizontal ui-controlgroup-vertical")
	...
	(function($, undefined) {
		...
		$.widget("mobile.popup", $.mobile.widget, {
			...
			_handleWindowResize: function(e) {
				if (this._isOpen && this._ignoreResizeTo === 0) {
					if ((this._expectResizeEvent() || this._orientationchangeInProgress) && !this._ui.container.hasClass("ui-popup-hidden")) {
						...
						this._ui.container.addClass("ui-popup-hidden")
							.removeAttr("style");
					}
				}
			},
			...
			_animate: function(args) {
				...
				this._ui.screen.removeClass(args.classToRemove)
				...
				if (args.transition && args.transition !== "none") {
					...
					if (this._fallbackTransition) {
						this._ui.container.animationComplete($.proxy(args.prereqs.container, "resolve"))
					...
					var self = this,
						...
						_openPanel = function() {
							...
							if (self.options.theme && self.options.display !== "overlay") {
								self._page.removeClass(self._pageTheme)
		...
		$.widget("mobile.selectmenu", $.mobile.widget, {
			...
			_create: function() {
				...
				// TODO values buttonId and menuId are undefined here
					button = this.button.insertBefore(this.select)
						.buttonMarkup({
							theme: options.theme,
							icon: options.icon,
							iconpos: iconpos,
			...
			build: function() {
				...
				this.select.appendTo(self.button)
	...
	(function($, undefined) {
		var extendSelect = function(widget) {
			...
			var select = widget.select,
				...
				menuPage = $("<div data-" + $.mobile.ns + "role='dialog' id='" + dialogID + "' data-" + $.mobile.ns + "theme='" + widget.options.theme + "' data-" + $.mobile.ns + "overlay-theme='" + widget.options.overlayTheme + "'>" + "<div data-" + $.mobile.ns + "role='header'>" + "<div class='ui-title'>" + label.getEncodedText() + "</div>" + "</div>" + "<div data-" + $.mobile.ns + "role='content'></div>" + "</div>"),
	...
	(function($, undefined) {
		...
		$.widget("mobile.fixedtoolbar", $.mobile.widget, {
			...
			_useTransition: function(notransition) {
				...
				return !notransition && (this.options.transition && this.options.transition !== "none" && (
					(tbtype === "header" && !this.options.fullscreen && scroll > elHeight) || (tbtype === "footer" && !this.options.fullscreen && scroll + viewportHeight < pHeight - elHeight)) || this.options.fullscreen);
			},
	...
	(function($, window) {
		...
		$.mobile.document.on("mobileinit", function() {
			if ($.mobile.iosorientationfixEnabled) {
				$.mobile.window.bind("orientationchange.iosorientationfix", zoom.enable)
